...
function SignaturePad() {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"flex-end" }}>
      ...
      {has && (
        <button onClick={clear} style={{ fontSize:11, color:"#bbb", background:"none",
...
const TtIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill={RED}>
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0
      0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0
      .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34
      6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.17 8.17 0 0 0
      4.77 1.52V6.72a4.85 4.85 0 0 1-1-.03z"/>
  </svg>
);
const XIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill={RED}>
    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231
      -5.401 6.231H2.762l7.638-8.73L2.25 2.25h6.946l4.262 5.638L18.244
...
export default function CotchInvoice() {
  /* ── Scale logic: invoice selalu 1:1 di semua layar ── */
  ...
  useEffect(() => {
    const refit = () => {
      ...
      if (avail < NATURAL_W) {
        ...
        // Tinggi visual setelah scale = getBoundingClientRect().height
    ...
    // Refit otomatis saat konten berubah (item ditambah/hapus, teks diketik)
    ...
    <>
      <style>{`
        ...
        *{ box-sizing:border-box; margin:0; padding:0; }
        ...
        /* Scale wrapper: overflow hidden agar layout-box card tidak meluber */
      ...
      <div className="wrap">
        ...
        <div ref={scalerRef} className="scaler">
          ...
          {/* Card invoice — ref untuk transform scale */}
          <div ref={cardRef} className="card"
            ...
            <div style={{ display:"flex", justifyContent:"space-between",
              ...
              <div style={{ minWidth:0 }}>
                ...
                <div style={{ display:"none", fontFamily:"'Playfair Display',Georgia,serif",
                  fontWeight:900, fontSize:36, color:RED, marginBottom:10 }}>Cotch</div>
                <div style={{ fontSize:11.5, color:"#999", lineHeight:2, textAlign:"left" }}>
                  <div>Jl. RE Martadinata No. 221, Cihapit, Bandung Wetan</div>
                  <div>Kota Bandung, Jawa Barat 40114</div>
                  <div>+62 816-1617-181</div>
                  <div>info@thisiscotch.com</div>
                  <div>thisiscotch.com</div>
                </div>
              </div>

              <div style={{ textAlign:"right", flexShrink:0 }}>
                <div style={{ fontFamily:"'Playfair Display',Georgia,serif",
                  fontWeight:900, fontSize:44, color:"#111", lineHeight:1, letterSpacing:-2 }}>
                  INVOICE
                </div>
                <div style={{ marginTop:8, display:"flex", justifyContent:"flex-end",
                  alignItems:"center", gap:6 }}>
                  <span style={{ fontSize:11.5, fontWeight:600, color:RED }}>No.</span>
                ...
                {[["Tanggal", issueDate, setIssueDate],
                  ...
                  <div key={lbl} style={{ display:"flex", justifyContent:"flex-end",
                    ...
                    <span style={{ fontSize:11.5, color:"#999" }}>{lbl}:</span>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", padding:"0 36px" }}>
              ...
              <div style={{ padding:"20px 28px 20px 0", borderRight:"1px solid #eeebe8" }}>
                ...
                <ClRow label="Email"   val={clientEmail} set={setClientEmail}
                  ph="email@klien.com" />
                <ClRow label="No. HP"  val={clientPhone} set={setClientPhone}
                  ph="+62 xxx-xxxx-xxxx" />
              </div>
              ...
              <table style={{ width:"100%", borderCollapse:"collapse" }}>
                <thead>
                  <tr>
                    ...
                    <th style={{ ...TH, width:150, textAlign:"right" }}>Harga Satuan (Rp)</th>
                    <th style={{ ...TH, width:150, textAlign:"right" }}>Jumlah</th>
                    <th className="no-print" style={{ ...TH, width:34 }} />
                  </tr>
                </thead>
                <tbody>
                  {items.map((item, idx) => {
                    const amt = Math.round(Number(item.qty||0) * Number(item.price||0));
                    return (
                      <tr key={item.id}
                    ...
                    <tr style={{ borderBottom:"1px solid #eee" }}>
                      <td style={TDL}>
                        ...
                        <label className="no-print"
                          style={{ marginLeft:8, cursor:"pointer", fontWeight:400 }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr",
              ...
              <div style={{ display:"flex", flexDirection:"column",
                ...
                <SignaturePad />
                <div style={{ fontSize:11.5, color:"#bbb", marginTop:6 }}>
            ...
            {/* ── FOOTER ── */}
            <div style={{ background:FOOTER_BG, padding:"13px 36px",
              display:"flex", justifyContent:"center", alignItems:"center",
              gap:24, fontSize:11.5, color:"#6b6257" }}>
